...
int8_t dhtESP8266::read11(uint8_t pin)
{
	// READ VALUES
...
int8_t dhtESP8266::read(uint8_t pin)
{
	// READ VALUES
...
int8_t dhtESP8266::_readSensor(uint8_t pin, uint8_t wakeupDelay, uint8_t leadingZeroBits)
{
